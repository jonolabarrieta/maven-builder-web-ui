...
The system SHALL execute Git operations (fetch, pull, checkout, discard, and restore/unstage) in parallel across selected projects when a bulk Git action is triggered.
